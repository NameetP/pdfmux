...
def classify_headings(
    ...
    page_width = page.rect.width  # noqa: F841 — kept for symmetry/future use
    ...
    for c in candidates:
        ...
        X = np.array([[features[col] for col in feature_cols]], dtype=np.float32)  # noqa: N806 — sklearn convention
