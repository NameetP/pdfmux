...
**Corpus:** GT-0, 23 documents across 8 categories (manifest SHA-256 `12f3a360d0b02c84cfd8cf62fcb6eabbb12821e3f516777defbea5950b4d6823`).  
...
|---|---:|---:|---:|---:|---:|
| `clean-gt` | 14 | 1 | 7.1% | 3 | 6 |
| `clean-pdfmux` | 14 | 1 | 7.1% | 4 | 6 |
...
|---|---|---:|---:|---:|---:|---:|
| `drop_page` | fail | 14 | 14 | 0 | 0.0% | 9 |
| `truncate_table` | flag | 4 | 1 | 3 | 75.0% | 0 |
| `inject_offsource` | flag | 14 | 14 | 0 | 0.0% | 9 |
| `severe_loss` | fail | 14 | 14 | 0 | 0.0% | 9 |

- `truncate_table` false negatives (verifier PASSed defective content): `arxiv-2203.02155-instructgpt`, `bls-empsit`, `irish-census-1926`
...
|---|---:|---:|---:|---:|
| clean (correct) | 20 | 12 | 2 | 12 |
| seeded defect | 9 | 19 | 33 | 12 |
...
- **Pure image-only scans (source < 20 chars → verifier verdict `unverifiable`):** 6 / 23 (26.1%).
- **Clean verification cases that hit at least one `unverifiable` page:** 12 / 46 (26.1%).
...
**1 of 24 corpus documents were not available and are excluded from every number above:** gao-24-106214. The rates here are therefore computed over a subset of the pre-registered corpus and are not comparable to a complete run.
